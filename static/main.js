...
$(document).ready(function(){
    ...
    // API page example dry run module 
      ...
      runButton.onclick = function() {
        ...
        fetch("/api/1595543414")
          ...
          .then(json => {
            ...
            // Show and enable click after API call
...
// Show less or more for the book review
function displaymore(e) {
    console.log("test")
    if ($(e).siblings("#reviewBody").hasClass("show-less")){
        $(e).siblings("#reviewBody").removeClass("show-less")
        $(e).text("Show less")
    } else {
        $(e).siblings("#reviewBody").addClass("show-less");
        $(e).text("Show more")
    }
}
